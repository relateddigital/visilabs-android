...
public class RVNewTry extends RecyclerView {
    ...
    public RVNewTry(@NonNull Context context) {
            super(context);
            mContext = context;
        }

    public RVNewTry(@NonNull Context context, @Nullable AttributeSet attrs) {
            super(context, attrs);
            mContext = context;
        }

    public RVNewTry(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
            super(context, attrs, defStyleAttr);
            mContext = context;
        }

        public void requestBannerCarouselActionRV(Context context,
            ...
            return new VisilabsCallback() {
                ...
                public void success(VisilabsResponse response) {
                    ...
                    try {
                        ...
                        bannerCarouselAdapter.setBannerList(RVNewTry.this, mAppBanner);
                        setHasFixedSize(true);
                        setAdapter(bannerCarouselAdapter);
                        SnapHelper snapHelper = new PagerSnapHelper();
                        snapHelper.attachToRecyclerView(RVNewTry.this);
