...
import com.visilabs.android.databinding.ActivityInlineInAppBinding;
...
public class InlineInAppActivity extends AppCompatActivity {
    ...
    private static final String LOG_TAG = "Inline_In_App Activity";
    ...
    private TemplateActivity.NpsSecondPopUpType secondPopUpType = TemplateActivity.NpsSecondPopUpType.IMAGE_TEXT_BUTTON;
    private TemplateActivity.NpsType npsType = TemplateActivity.NpsType.NONE;
    ...
    private ActivityInlineInAppBinding binding;
        ...
        protected void onCreate(Bundle savedInstanceState) {
            ...
            if(mInAppMessage == null) {
                ...
                if (mInAppMessage.getActionData().getMsgType() == InAppActionType.CAROUSEL) {
                    ...
                    mIsCarousel = false;
                    binding = ActivityInlineInAppBinding.inflate(getLayoutInflater());
        ...
        private void setTemplate() {
            ...
            if(mInAppMessage.getActionData().getBackground() != null && !mInAppMessage.getActionData().getBackground().equals("")) {
                try {
                    binding.flBack.setBackgroundColor(Color.parseColor(mInAppMessage.getActionData().getBackground()));
                } catch (Exception e) {
            ...
            switch (mInAppMessage.getActionData().getMsgType()) {
                ...
                case NPS:
                    npsType = TemplateActivity.NpsType.NPS;
                    setTitle();
                    setBody();
                    setButton();
                    showNps();
                ...
                case SMILE_RATING:
                    npsType = TemplateActivity.NpsType.SMILE_RATING;
                    setBody();
                    setTitle();
                    setButton();
                    showSmileRating();
                ...
                case NPS_WITH_NUMBERS:
                    //if(mInAppMessage.getActionData().getDisplayType().equals("popup"))
                    npsType = TemplateActivity.NpsType.NPS_WITH_NUMBERS;
                    binding.smileRating.setVisibility(View.GONE);
                    setBody();
                    setTitle();
                    setButton();
                ...
                case NPS_AND_SECOND_POP_UP:
                    npsType = TemplateActivity.NpsType.NPS_WITH_SECOND_POPUP;
        ...
        private void setNpsSecondPopUpCloseButton() {
            ...
            switch (mInAppMessage.getActionData().getSecondPopupType()) {
                case "image_text_button": {
                    secondPopUpType = TemplateActivity.NpsSecondPopUpType.IMAGE_TEXT_BUTTON;
                    break;
                }

                case "image_text_button_image": {
                    secondPopUpType = TemplateActivity.NpsSecondPopUpType.IMAGE_TEXT_BUTTON_IMAGE;
                    break;
                }

                case "feedback_form": {
                    secondPopUpType = TemplateActivity.NpsSecondPopUpType.FEEDBACK_FORM;
                    break;
                }
            }
        }
        ...
        private void setButton() {
            ...
            if(mInAppMessage.getActionData().getBtnText().equals("") ||
                ...
                binding.btnTemplate.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        if (npsType == TemplateActivity.NpsType.NONE) {
                            Visilabs.CallAPI().trackInAppMessageClick(mInAppMessage, getRateReport());
                            if (buttonCallback != null) {
                                Visilabs.CallAPI().setInAppButtonInterface(null);
                                buttonCallback.onPress(mInAppMessage.getActionData().getAndroidLnk());
        ...
        private void setNpsSecondPopUpButton() {
            ...
            binding.btnTemplate.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    releasePlayer();
                    if(binding.ratingBar.getRating()!=0) {
                        if (secondPopUpType == TemplateActivity.NpsSecondPopUpType.FEEDBACK_FORM) {
