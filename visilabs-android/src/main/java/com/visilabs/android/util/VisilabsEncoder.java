...
public class VisilabsEncoder {
    ...
    public static String encode(String value){
        try {
            return URLEncoder.encode(value, VisilabsConfig.VISILABS_ENCODING_CHARSET).replace("+", "%20");
        }catch (Exception e) {
    ...
    public static String decode(String value){
        try {
            return URLDecoder.decode(value, VisilabsConfig.VISILABS_ENCODING_CHARSET);
        }catch (Exception e) {
