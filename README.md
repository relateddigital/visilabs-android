...
***April 10, 2023*** - [Visilabs v6.0.8](https://github.com/relateddigital/visilabs-android/releases)
...
```java
implementation 'com.github.relateddigital:visilabs-android:6.0.8'
```
