...
***November 12, 2021*** - [Visilabs v5.8.5](https://github.com/relateddigital/visilabs-android/releases)
...
```java
implementation 'com.github.relateddigital:visilabs-android:5.8.5'
```
