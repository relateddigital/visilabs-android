...
***February 22, 2021*** - [Visilabs v5.4.7-beta](https://github.com/relateddigital/visilabs-android/releases)
...
```java
implementation "com.visilabs.android:visilabs-android-beta:5.4.7-beta
```
