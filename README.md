...
***February 11, 2022*** - [Visilabs v5.9.2](https://github.com/relateddigital/visilabs-android/releases)
...
```java
implementation 'com.github.relateddigital:visilabs-android:5.9.2'
```
