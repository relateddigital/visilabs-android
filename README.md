...
***September 3, 2021*** - [Visilabs v5.7.0](https://github.com/relateddigital/visilabs-android/releases)
...
```java
implementation 'com.github.relateddigital:visilabs-android:5.7.0'
```
