...
***November 9, 2021*** - [Visilabs v5.8.2](https://github.com/relateddigital/visilabs-android/releases)
...
```java
implementation 'com.github.relateddigital:visilabs-android:5.8.2'
```
