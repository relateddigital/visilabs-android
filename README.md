...
***March 30, 2022*** - [Visilabs v5.9.5](https://github.com/relateddigital/visilabs-android/releases)
...
```java
implementation 'com.github.relateddigital:visilabs-android:5.9.5'
```
