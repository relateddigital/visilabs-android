...
***August 28, 2023*** - [Visilabs v6.1.4](https://github.com/relateddigital/visilabs-android/releases)
...
```java
implementation 'com.github.relateddigital:visilabs-android:6.1.4'
```
